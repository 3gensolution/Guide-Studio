...
/**
 * Compact recording-bar window that appears at the top-centre of the screen
 * while a recording is in progress, showing elapsed time and stop control.
 * Content-protected so it never appears in the capture itself.
 */
