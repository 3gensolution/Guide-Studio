...
final class ScreenCaptureRecorder: NSObject, SCStreamOutput, SCStreamDelegate {
	...
	private let sampleQueue = DispatchQueue(label: "app.guidestudio.sck-helper.samples")
	private let stateQueue = DispatchQueue(label: "app.guidestudio.sck-helper.state")
...
@main
struct GuideScreenCaptureKitHelper {
