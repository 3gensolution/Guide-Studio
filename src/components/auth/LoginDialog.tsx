			...
			<DialogContent className="sm:max-w-md bg-gradient-to-b from-[#1C1917] to-[#070809] border border-white/10">
				<DialogHeader>
					<div className="flex items-center gap-3 mb-2">
						<div className="w-12 h-12 rounded-xl bg-gradient-to-r from-[#A855F7]/20 to-[#22D3EE]/20 border border-[#A855F7]/30 flex items-center justify-center">
							<Sparkles className="w-6 h-6 text-[#A855F7]" />
						</div>
						<div>
							<DialogTitle className="text-2xl font-bold bg-gradient-to-r from-[#A855F7] to-[#22D3EE] bg-clip-text text-transparent">
				...
				<form onSubmit={handleSubmit} className="space-y-4 mt-4">
						...
						<>
							<div className="space-y-2">
								...
								<input
									...
									className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder:text-white/40 focus:outline-none focus:border-[#A855F7]/50 focus:ring-2 focus:ring-[#A855F7]/20 transition-all"
					...
					<Button
						type="submit"
						disabled={isLoading}
						className="w-full py-6 text-base font-semibold bg-gradient-to-r from-[#A855F7] to-[#22D3EE] hover:shadow-[0_0_30px_rgba(168,85,247,0.3)] transition-all duration-200"
					>
					...
					>
						{mode === "login" ? (
							<>
								Don't have an account? <span className="text-[#A855F7] font-medium">Sign up</span>
							</>
						) : (
							<>
								Already have an account? <span className="text-[#A855F7] font-medium">Sign in</span>
							</>
						)}
					</button>
				</form>
				...
				<div className="mt-6 p-4 rounded-xl bg-white/[0.02] border border-white/[0.05]">
					...
					<ul className="space-y-2 text-xs text-white/60">
						<li className="flex items-center gap-2">
							<div className="w-1.5 h-1.5 rounded-full bg-gradient-to-r from-[#A855F7] to-[#22D3EE]" />
