...
function ZoomFocusCoordInput({
	...
	return (
		<input
			...
			className="h-7 w-full rounded-md border border-white/10 bg-white/5 px-2 text-[11px] text-slate-200 outline-none focus:border-[#00B8FF]/50 focus:ring-1 focus:ring-[#00B8FF]/30 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none disabled:opacity-50 disabled:cursor-not-allowed"
		/>
	);
}
							...
							<button
								...
								className={cn(
									...
									mode.disabled
										...
										: isActive
											? "border-[#00B8FF]/50 bg-[#00B8FF]/15 text-[#00B8FF] shadow-[0_0_0_1px_rgba(0,184,255,0.12)]"
					...
					{zoomEnabled && (
						<div className="editor-panel-section mb-3 space-y-3 px-1">
							<div className="flex items-center justify-between">
								...
								<span className="rounded-full border border-[#00B8FF]/25 bg-[#00B8FF]/10 px-2 py-0.5 text-[11px] font-semibold tabular-nums text-[#00B8FF]">
									{(
										selectedZoomCustomScale ??
									...
									return (
										<Button
											...
											className={cn(
												...
												isActive
													? "border-[#00B8FF]/70 bg-[#00B8FF] text-white shadow-[0_8px_20px_rgba(0,184,255,0.18)]"
									...
									>
										<SliderPrimitive.Track className="relative h-1.5 w-full grow overflow-hidden rounded-full border border-white/10 bg-white/5">
											<SliderPrimitive.Range
												className={cn(
													...
													selectedZoomCustomScale != null ? "bg-[#00B8FF]" : "bg-white/20",
												)}
											/>
										...
										<SliderPrimitive.Thumb
											className={cn(
												...
												"focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#00B8FF]/50",
												"disabled:pointer-events-none disabled:opacity-50 cursor-grab active:cursor-grabbing",
												selectedZoomCustomScale != null
													? "border-[#00B8FF] bg-[#00B8FF] shadow-[0_0_6px_rgba(0,184,255,0.4)]"
												...
												return (
													<Button
														...
														className={cn(
															...
															isActive
																? "border-[#00B8FF]/50 bg-[#00B8FF] text-white"
							...
							{zoomEnabled && onZoomPreviewStart && onZoomPreviewEnd && (
								<Button
									...
									className="h-7 w-full select-none rounded-md border border-white/[0.08] bg-white/[0.04] text-[10px] font-semibold text-slate-300 transition-all duration-150 ease-out hover:bg-white/[0.08] hover:text-slate-100 active:border-[#00B8FF]/50 active:bg-[#00B8FF] active:text-white cursor-pointer"
								>
									{t("zoom.previewHold")}
								</Button>
							)}
											...
											return (
												<Button
													...
													className={cn(
														...
														isActive
															? "border-[#00B8FF]/60 bg-[#00B8FF] text-white"
															: "border-white/[0.06] bg-white/[0.035] text-slate-400 hover:bg-white/[0.075] hover:border-white/15 hover:text-slate-200",
													)}
												>
										...
										{webcamLayoutPreset !== "no-webcam" && (
											<div className="mt-2 flex items-center justify-between p-2 rounded-lg editor-control-surface">
												...
												<Switch
													...
													className="data-[state=checked]:bg-[#00B8FF] scale-90"
														...
														<button
															...
															className={cn(
																...
																webcamMaskShape === shape.value
																	? "bg-[#00B8FF] border-[#00B8FF] text-white"
																		...
																		return (
																			<button
																				...
																				className={cn(
																					...
																					isSelected
																						? "border-[#00B8FF] ring-1 ring-[#00B8FF]/30"
																						: "border-white/10 hover:border-[#00B8FF]/40 opacity-80 hover:opacity-100",
																				)}
																			>
																				<img
									...
									<AccordionContent className="pb-3">
										<Tabs defaultValue="image" className="w-full">
											<TabsList className="mb-2 bg-white/5 border border-white/5 p-0.5 w-full grid grid-cols-3 h-7 rounded-lg">
												<TabsTrigger
													value="image"
													className="data-[state=active]:bg-[#00B8FF] data-[state=active]:text-white text-slate-400 text-[10px] py-1 rounded-md transition-all"
												>
													{t("background.image")}
												</TabsTrigger>
												<TabsTrigger
											...
											<div className="overflow-y-auto custom-scrollbar">
												<TabsContent value="image" className="mt-0 space-y-2">
													...
													<Button
														...
														variant="outline"
														className="w-full gap-2 bg-white/5 text-slate-200 border-white/10 hover:bg-[#00B8FF] hover:text-white hover:border-[#00B8FF] transition-all h-7 text-[10px]"
													>
															...
															return (
																<div
																	...
																	className={cn(
																		...
																		isSelected
																			? "border-[#00B8FF] ring-1 ring-[#00B8FF]/30"
																			: "border-white/10 hover:border-[#00B8FF]/40 opacity-80 hover:opacity-100 bg-white/5",
																	)}
																	style={{
									...
									<AccordionContent className="pb-3">
										<div className="flex items-center justify-between p-2 rounded-lg editor-control-surface">
											...
											<Switch
												...
												className="data-[state=checked]:bg-[#00B8FF] scale-90 ml-2 shrink-0"
											/>
										</div>
									</AccordionContent>
								</AccordionItem>
						...
						<div className="mt-6 space-y-4">
								...
								{[
									...
									<div key={field} className="flex flex-col gap-1">
										...
										<input
											...
											className="w-[90px] h-8 rounded-md border border-white/10 bg-white/5 px-2 text-xs text-slate-200 outline-none focus:border-[#00B8FF]/50 focus:ring-1 focus:ring-[#00B8FF]/30 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
										/>
									</div>
								))}
								...
								<div className="flex flex-col gap-1">
									...
									<div className="flex items-center gap-1.5">
										<select
											...
											className="h-8 rounded-md border border-white/10 bg-[#1a1a1f] px-2 text-xs text-slate-200 outline-none focus:border-[#00B8FF]/50 cursor-pointer"
										>
										...
										<button
											...
											className={cn(
												...
												cropAspectLocked
													? "border-[#00B8FF]/50 bg-[#00B8FF]/10 text-[#00B8FF]"
							...
							<div className="flex justify-end">
								<Button
									onClick={() => setShowCropDropdown(false)}
									size="lg"
									className="bg-[#00B8FF] hover:bg-[#00B8FF]/90 text-white"
								>
									{t("crop.done")}
								</Button>
							</div>
				...
				{activePanelMode === "export" && !hasTimelineSelection && (
					<>
						<div className="flex items-center gap-2 mb-3">
							<button
								...
								className={cn(
									...
									exportFormat === "mp4"
										? "bg-[#00B8FF]/10 border-[#00B8FF]/50 text-white"
								...
								<div className="flex items-center justify-between">
									...
									<div className="flex items-center gap-2">
										...
										<Switch
											...
											className="data-[state=checked]:bg-[#00B8FF] scale-75"
										/>
									</div>
								</div>
							</div>
						...
						<Button
							...
							size="lg"
							onClick={onExport}
							className="w-full py-5 text-sm font-semibold flex items-center justify-center gap-2 bg-gradient-to-r from-[#00B8FF] to-[#A855F7] text-white rounded-xl shadow-lg shadow-[#00B8FF]/30 hover:shadow-[#00B8FF]/40 hover:scale-[1.01] active:scale-[0.99] transition-all duration-200"
						>
							<Download className="w-4 h-4" />
