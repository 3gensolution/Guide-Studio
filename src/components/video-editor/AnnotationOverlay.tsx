...
export function AnnotationOverlay({
	...
	const renderArrow = () => {
		...
		const color = annotation.figureData?.color || "#00B8FF";
					...
					<div className="w-full h-full relative">
						...
						>
							...
							{isSelected && shape !== "freehand" && (
								<div
									className="absolute inset-0 pointer-events-none border-2 border-[#00B8FF]/80"
	...
	return (
		<Rnd
			...
			className={cn(
				...
				isSelected &&
					annotation.type !== "blur" &&
					"ring-2 ring-[#00B8FF] ring-offset-2 ring-offset-transparent",
			)}
			style={{
			...
			resizeHandleStyles={{
				topLeft: {
					...
					border: isSelected ? "2px solid #00B8FF" : "none",
					borderRadius: "50%",
					left: "-6px",
					top: "-6px",
					cursor: "nwse-resize",
