				...
				return (
					<button
						...
						className={cn(
							...
							"focus:outline-none focus:ring-2 focus:ring-[#A855F7]/50 focus:ring-offset-2 focus:ring-offset-[#1C1917]",
							isSelected
					...
					>
						<div
							className={cn(
								...
								isSelected ? "bg-[#A855F7]/20 text-[#A855F7]" : "bg-white/5",
							)}
						>
							{option.icon}
						</div>
						...
						{isSelected && (
							<div className="absolute top-2 right-2 w-2 h-2 rounded-full bg-[#A855F7]" />
						)}
					</button>
				);
			})}
