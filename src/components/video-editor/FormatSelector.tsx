				...
				return (
					<button
						...
						className={cn(
							...
							"focus:outline-none focus:ring-2 focus:ring-[#6E6BFF]/50 focus:ring-offset-2 focus:ring-offset-[#1C1917]",
							isSelected
					...
					>
						<div
							className={cn(
								...
								isSelected ? "bg-[#6E6BFF]/20 text-[#6E6BFF]" : "bg-white/5",
							)}
						>
							{option.icon}
						</div>
						...
						{isSelected && (
							<div className="absolute top-2 right-2 w-2 h-2 rounded-full bg-[#6E6BFF]" />
						)}
					</button>
				);
			})}
