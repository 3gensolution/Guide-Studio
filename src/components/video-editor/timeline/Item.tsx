...
import { Film, Gauge, MessageSquare, MousePointer2, Scissors, ZoomIn } from "lucide-react";
...
interface ItemProps {
	...
	speedValue?: number;
	isAutoFocus?: boolean;
	variant?: "zoom" | "trim" | "annotation" | "speed" | "blur" | "clip";
}
