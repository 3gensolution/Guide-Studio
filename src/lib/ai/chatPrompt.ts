...
export function buildSystemPrompt(context: ChatPromptContext): string {
	...
	const parts: string[] = [
		`You are an AI video editing assistant for Guide Studio, a screen recording editor. You help users edit their recordings through natural language conversation.`,
		``,
		`## Recording Context`,
