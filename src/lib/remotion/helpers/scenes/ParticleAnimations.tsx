...
export const ParticleBubbles = ({ startDelay = 0 }: { startDelay?: number }) => {
...
export const ParticleConfetti = ({ startDelay = 0 }: { startDelay?: number }) => {
	const frame = useCurrentFrame();
...
export const ParticleFireworks = ({ startDelay = 0 }: { startDelay?: number }) => {
	const frame = useCurrentFrame();
...
export const ParticleLightning = ({ startDelay = 0 }: { startDelay?: number }) => {
	const frame = useCurrentFrame();
...
export const ParticleMagneticField = ({ startDelay = 0 }: { startDelay?: number }) => {
	const frame = useCurrentFrame();
...
export const ParticleSakura = ({ startDelay = 0 }: { startDelay?: number }) => {
	const frame = useCurrentFrame();
	const { height } = useVideoConfig();
...
export const ParticleShootingStars = ({ startDelay = 0 }: { startDelay?: number }) => {
	const frame = useCurrentFrame();
...
export const ParticleSmoke = ({ startDelay = 0 }: { startDelay?: number }) => {
	const frame = useCurrentFrame();
...
export const ParticleSnow = ({ startDelay = 0 }: { startDelay?: number }) => {
	const frame = useCurrentFrame();
	const { height } = useVideoConfig();
...
export const ParticleSparks = ({ startDelay = 0 }: { startDelay?: number }) => {
	const frame = useCurrentFrame();
